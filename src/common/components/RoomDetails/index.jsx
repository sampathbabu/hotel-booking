...
const RoomDetails = () => {
  ...
  return (
    <Grid container display={"flex"}>
      ...
      <Grid item sm={"8"} xs={"12"} bgcolor="red">
        <Grid container>
          <Grid item>
            ...
            on the first list view of all rooms. This is where we, as
            Profitroom, can help hoteliers by properly designing their room
            list. The list should show only the key features in a concise form,
            without any unnecessary text. Guests shouldn't have to read such a
            description – it’s enough to scan it to know the rooms’ key features
            and to compare them.
          </Grid>
          <Grid item>
